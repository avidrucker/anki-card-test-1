...
const availableDesigns = ["8 Bit Console.json", "Blackboard and Chalk.json", "Blueprint Theme.json", "Code Rain.json", "Full Photo.json", "Index Card.json", "Ink on Ricepaper.json", "Zenburn Theme.json"];
